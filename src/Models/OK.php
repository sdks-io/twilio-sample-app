...
class OK implements \JsonSerializable
{
    ...
    /**
     * @param AvailablePhoneNumber[] $availablePhoneNumbers
     * @param int $end
    ...
    /**
     * Sets Available Phone Numbers.
     *
     * @required
     * @maps available_phone_numbers
     *
     * @param AvailablePhoneNumber[] $availablePhoneNumbers
     */
    public function setAvailablePhoneNumbers(array $availablePhoneNumbers): void
    {
        $this->availablePhoneNumbers = $availablePhoneNumbers;
    }
    ...
    {
        $json = [];
        $json['available_phone_numbers'] = $this->availablePhoneNumbers;
        $json['end']                     = $this->end;
